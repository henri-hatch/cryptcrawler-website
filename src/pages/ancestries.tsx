...
const AncestriesPage = () => {
  return (
    <>
      ...
      <ContentCard 
          title="Half-Elf"
          imagePath="/ancestry-images/half_elf_logo.png" 
          linkTo="/ancestries/half-elf"
      ...
      <ContentCard 
          title="Half-Orc"
          imagePath="/ancestry-images/half_orc_logo.png"
          linkTo="/ancestries/half-orc"
      ...
      <ContentCard 
          ...
          linkTo="/ancestries/kobold"
          description="Despite the draconic appearance, Kobolds are completely unrelated to dragonborn. Created by the commerce god Marcadia, Kobolds are natural miners and appraisers. Often seen as hoarders and theives by other ancestries, a Kobold's mathmatical mind is often overlooked."
          className="race-card"
        />

      <ContentCard 
          title="Mul"
          imagePath="/ancestry-images/mul_logo.png" 
          linkTo="/ancestries/mul"
      ...
      <ContentCard 
          title="Orc"
          imagePath="/ancestry-images/orc_logo.png" 
          linkTo="/ancestries/orc"
