...
const conduitTree = defineSkillTree({ gridSize: 7, useAdjacency: true, defaultEdgeType: 'straight' });
...
conduitTree.connect('tier2-1', 'mastery', { type: 'curved', side: 'right', strength: 1 });
conduitTree.connect('tier2-3', 'mastery', { type: 'curved', side: 'left', strength: 1 });
